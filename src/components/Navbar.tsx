        ...
        <div className="flex items-center justify-between h-full">
                ...
                <div className="flex items-center gap-1.5">
                  {isSyncConnected ? (
                    <div 
                      ...
                      title={`Connected to Google Cloud Firestore. Updates replicate instantly across all team members. Last sync: ${lastSyncTime || 'now'}`}
                    >
                    ...
                    <div 
                      ...
                      title="Operating in local cache. Click Sync to reconnect to cloud database."
                    >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {user ? (
              ...
              <button
                onClick={onLogin}
                title="Sign in with Google to tag your advisor updates"
                className="hidden lg:flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg border border-slate-200 transition-colors"
              >
